...
export class QuestionAddGrouping1559358400184 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `question` ADD `grouping` int NOT NULL DEFAULT 0");
        ...
        INSERT INTO wrf.question (text, short_name, topic, tooltip, instructions, datatype, is_active, created_by, updated_by, cat_fk, \`grouping\`)
         VALUES 
             ...
             ('Front Length', 'cab_fl', 'Cabinet Front Length', 'enter front length for cabinet', '', 'number', 1, 'admin', 'admin', 10, 2),
             ('Front Width', 'cab_fw', 'Cabinet Front Width', 'enter front width for cabinet', '', 'number', 1, 'admin', 'admin', 10, 2),
             ('Side Length', 'cab_sl', 'Cabinet Side Length', 'enter side length for cabinet', '', 'number', 1, 'admin', 'admin', 10, 3),
             ('Side Width', 'cab_sw', 'Cabinet Side Width', 'enter side width for cabinet', '', 'number', 1, 'admin',  'admin', 10, 3),
             ('Back Length', 'cab_bl', 'Cabinet Back Length', 'enter back length for cabinet', '', 'number', 1, 'admin', 'admin', 10, 4),
             ('Back Width', 'cab_bw', 'Cabinet Back Width', 'enter back width for cabinet', '', 'number', 1, 'admin', 'admin', 10, 4),
             ('Material Type', 'cab_mt', 'Cabinet Material Type', 'enter material type for cabinet', '', 'string', 1, 'admin', 'admin', 10, 5),
             ...
             ('Length', 'dr_wdth', 'Door Width', 'enter width for doors', '', 'number', 1, 'admin',  'admin', 9, 3),
             ...
             ('Length', 'top_lngth', 'Top Length', 'enter length for top', '', 'number', 1, 'admin', 'admin', 5, 1),
             ('Width', 'top_wdth', 'Top Width', 'enter width for top', '', 'number', 1, 'admin', 'admin', 5, 1),
             ('Vendor', 'dwrfrnts_vndr', 'Drawer Fronts Vendor', 'enter vendor for drawer fronts', '', 'string', 1, 'admin',  'admin', 6, 0),
             ('Vendor PO#', 'dwrfrnts_vndr', 'Drawer Fronts Vendor PO#', 'enter vendor PO# for drawer fronts', '', 'string', 1, 'admin', 'admin', 6, 0),
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `question` DROP COLUMN `grouping`");
    }
